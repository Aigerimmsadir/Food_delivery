...
from main.models import Restaurant,City,Dish,Review,RestaurantReview,DishReview,Order,OrderItem
...
class RestaurantModelSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        tracks_data=validated_data.pop('city')
        city = City.objects.get(**tracks_data)
        rest = Restaurant.objects.create(city=city,**validated_data)
